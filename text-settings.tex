...
\usepackage{text-template/packages/avm}
%%%%%%%%%%%%%%%%%%%%%%
%   AVM SETTINGS     % 
%%%%%%%%%%%%%%%%%%%%%%
...
%% Bibliography
\newcommand{\mycitestyle}{text-template/bst/biblatex-sp-unified/cbx/sp-authoryear-comp}
\newcommand{\mystyle}{text-template/bst/biblatex-sp-unified/bbx/biblatex-sp-unified}
%%%%%%%%%%%%%%%%%%%%%%%%
%   BIBLATEX SETTINGS  % 
%%%%%%%%%%%%%%%%%%%%%%%%
\makeatletter
